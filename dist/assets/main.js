            ...
            <div class="card-container">
              <div class="card-container__card-header">
                ...
                <div class="card-container__card-header__numbers-rating-container">
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===1?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
                    <p class="card-container__card-header__numbers-rating-container__number-rating-container__number-rating">1</p>
                  </div>
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===2?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
                    <p class="card-container__card-header__numbers-rating-container__number-rating-container__number-rating">2</p>
                  </div>
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===3?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
                    <p class="card-container__card-header__numbers-rating-container__number-rating-container__number-rating">3</p>
                  </div>
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===4?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
                    <p class="card-container__card-header__numbers-rating-container__number-rating-container__number-rating">4</p>
                  </div>
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===5?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
                    <p class="card-container__card-header__numbers-rating-container__number-rating-container__number-rating">5</p>
                  </div>
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===6?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
                    <p class="card-container__card-header__numbers-rating-container__number-rating-container__number-rating">6</p>
                  </div>
                  <div class="card-container__card-header__numbers-rating-container__number-rating-container ${n.srri===7?"card-container__card-header__numbers-rating-container__number-rating-container--active":""}">
...
`,o.map(n=>f.innerHTML+=`
  ...
  `),document.querySelectorAll(".support-card-container").forEach(v=>v.addEventListener("click",()=>F(v)))}}if(document.querySelector(".alta-news-talking-about-container")){let m=function(t){i.forEach(l=>{l.getAttribute("data-attr")===t&&l.classList.add("activePage")}),s.innerHTML="",r.slice((t-1)*4,t*4).forEach(l=>s.innerHTML+=`
...
`)};var displayNews=m;const r=[{date:"22 Juillet 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"21 Juin 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"2 Juin 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"15 Mai 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"10 Mai 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"26 Avril 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"31 Mars 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"11 Mars 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"10 Mars 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"22 Février 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"12 Février 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"10 Février 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"9 Janvier 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"}],e=document.querySelector(".alta-news-talking-about-container__left-container__pages-navigation__pages-numbers"),d=Math.ceil(r.length/4);e.innerHTML="";for(let t=1;t<=d;t++)e.innerHTML+=`
        ...
        `;const i=document.querySelectorAll(".alta-news-talking-about-container__left-container__pages-navigation__pages-numbers__btn");i.forEach(t=>t.addEventListener("click",l=>{i.forEach(g=>g.classList.remove("activePage")),m(l.target.getAttribute("data-attr"))}));const s=document.querySelector(".alta-news-talking-about-container__left-container__news-container");m(1)}if(document.querySelector(".experts-voice-section")){let m=function(l){i.forEach(g=>{g.getAttribute("data-attr")===l&&g.classList.add("active")}),s.innerHTML="",r.slice((l-1)*3,l*3).forEach(g=>s.innerHTML+=`
    ...
    >
      ...
      >
       ${a.description}
        ...
        `})}});if(document.querySelector(".capital-calculator-section")){let t=function(){let _=d.valueAsNumber;const f=s.valueAsNumber,S=m.valueAsNumber/100,a=i.valueAsNumber;for(let p=0;p<f;p++)for(let h=0;h<12;h++){const y=S*_;_+=y*(1/12)+a}_=Math.round(_/1e3)*1e3,_.toString().split("").splice(-3,0," "),l(r,_,500)},l=function(_,f,S){const p=S/10;let h=0;const y=(f-0)/p;function L(){h+=y,h>=f?_.textContent=`${g(f)} €`:(_.textContent=`${g(h.toFixed(0))} €`,setTimeout(L,10))}L()},g=function(_){return _.toString().replace(/\B(?=(\d{3})+(?!\d))/g," ")};var calculateResult=t,animateNumber=l,numberWithSpaces=g;const r=document.querySelector(".capital-calculator-section__result-value"),e=document.querySelectorAll(".capital-calculator-section__cursors-container__cursor-container input"),d=document.querySelector("#first-range"),i=document.querySelector("#second-range"),s=document.querySelector("#third-range"),m=document.querySelector("#fourth-range");e.forEach(_=>_.addEventListener("input",function(){const f=(this.value-this.min)/(this.max-this.min)*100,S=_.value.split("");S.splice(-3,0," "),(_.name="first-range")&&(_.labels[0].textContent=`${S.join("")} ${_.getAttribute("data-attr")}`),this.style.background=`linear-gradient(to right, #ff6442 0%, #ff6442 ${f}%, #fbe1da ${f}%, #fbe1da 100%)`,t()})),t()}const U=document.querySelectorAll(".promo-banner-section");U.forEach(r=>{r.querySelector(".promo-banner-section__items-section__items");const e=r.querySelectorAll(".promo-banner-section__items-section__items__item"),d=r.querySelector(".promo-banner-section__items-section__left-arrow"),i=r.querySelector(".promo-banner-section__items-section__right-arrow");let s=0;e.length>1&&(i.style.display="block",d.style.display="block",i.addEventListener("click",()=>{s=(s+1)%e.length,m(s)},{passive:!0}),d.addEventListener("click",()=>{s=(s-1+e.length)%e.length,m(s)},{passive:!0}));function m(t){e.forEach(l=>{l.style.transform=`translateX(-${t*100}%)`})}m(s)});const Y={initialInvestissement:1e5,selectedBtns:["France","Europe","Commerces"]};document.querySelector(".scpi-selector__selectors-container__resultsCards");const G=document.querySelectorAll(".scpi-selector__selectors-container__sectoralCategory__btns-container__btn, .scpi-selector__selectors-container__geographicalArea__btns-container__btn"),q=document.querySelector(".scpi-selector__selectors-container__initial-investissement-container input"),k=document.querySelector(".scpi-selector__selectors-container__initial-investissement-container label");q.addEventListener("input",M);G.forEach(r=>r.addEventListener("click",e=>H(e,Y.selectedBtns)));function M(){Y.initialInvestissement=q.value;const r=(q.value-q.min)/(q.max-q.min)*100,e=q.value.split("");e.splice(-3,0," "),k.textContent=`${e.join("")} €`,q.style.background=`linear-gradient(to right, #ff6442 0%, #ff6442 ${r}%, #fbe1da ${r}%, #fbe1da 100%)`}function H(r,e){const d=r.target.getAttribute("data-attr");handleSelectedOptionBtn(e,d)}
