(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const t of c.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&s(t)}).observe(document,{childList:!0,subtree:!0});function i(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(r){if(r.ep)return;r.ep=!0;const c=i(r);fetch(r.href,c)}})();const U=`<a class="button button--primary" href="#"> Button</a>\r
\r
...
\r
<a class="link link--arrow" href="#">Link</a>`,Y='<a class="file-link" href="#">FileLink</a>',J='<span class="tag">Tag</span> <span class="tag active">Tag active</span>',Z=[{name:"button",template:U},{name:"iconButton",template:O},{name:"toggleButton",template:G},{name:"tab",template:D},{name:"link",template:H},{name:"fileLink",template:Y},{name:"tag",template:J}],Q=`<div class="breadcrumb">\r
...
`,Zn=`<section class="squad-container">\r
...
</section>`,se=`<section class="lexique-section">\r
...
</section>`,ae=`<section class="contact-us-section">\r
...
`,l.map(a=>g.innerHTML+=`
  ...
  `),document.querySelectorAll(".support-card-container").forEach(h=>h.addEventListener("click",()=>R(h)))}}if(document.querySelector(".alta-news-talking-about-container")){let c=function(t){s.forEach(p=>{p.getAttribute("data-attr")===t&&p.classList.add("activePage")}),r.innerHTML="",e.slice((t-1)*4,t*4).forEach(p=>r.innerHTML+=`
