(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const c of e)if(c.type==="childList")for(const r of c.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function a(e){const c={};return e.integrity&&(c.integrity=e.integrity),e.referrerPolicy&&(c.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?c.credentials="include":e.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(e){if(e.ep)return;e.ep=!0;const c=a(e);fetch(e.href,c)}})();const j=`<a class="button button--primary" href="#"> Button</a>\r
\r
...
`,l.map(i=>g.innerHTML+=`
  ...
  `),document.querySelectorAll(".support-card-container").forEach(h=>h.addEventListener("click",()=>z(h)))}}if(document.querySelector(".alta-news-talking-about-container")){let c=function(r){s.forEach(p=>{p.getAttribute("data-attr")===r&&p.classList.add("activePage")}),e.innerHTML="",t.slice((r-1)*4,r*4).forEach(p=>e.innerHTML+=`
...
`)};var displayNews=c;const t=[{date:"22 Juillet 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"21 Juin 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"2 Juin 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"15 Mai 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"10 Mai 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"26 Avril 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"31 Mars 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"11 Mars 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"10 Mars 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"22 Février 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"12 Février 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"10 Février 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"9 Janvier 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"}],n=document.querySelector(".alta-news-talking-about-container__left-container__pages-navigation__pages-numbers"),a=Math.ceil(t.length/4);n.innerHTML="";for(let r=1;r<=a;r++)n.innerHTML+=`
        ...
        `;const s=document.querySelectorAll(".alta-news-talking-about-container__left-container__pages-navigation__pages-numbers__btn");s.forEach(r=>r.addEventListener("click",p=>{s.forEach(v=>v.classList.remove("activePage")),c(p.target.getAttribute("data-attr"))}));const e=document.querySelector(".alta-news-talking-about-container__left-container__news-container");c(1)}if(document.querySelector(".experts-voice-section")){let c=function(p){s.forEach(v=>{v.getAttribute("data-attr")===p&&v.classList.add("active")}),e.innerHTML="",t.slice((p-1)*3,p*3).forEach(v=>e.innerHTML+=`
    ...
    >
      ...
      >
       ${o.description}
        ...
        `})}});if(document.querySelector(".capital-calculator-section")){let r=function(){let _=a.valueAsNumber;const g=e.valueAsNumber,x=c.valueAsNumber/100,o=s.valueAsNumber;for(let m=0;m<g;m++)for(let f=0;f<12;f++){const w=x*_;_+=w*(1/12)+o}_=Math.round(_/1e3)*1e3,_.toString().split("").splice(-3,0," "),p(t,_,500)},p=function(_,g,x){const m=x/10;let f=0;const w=(g-0)/m;function y(){f+=w,f>=g?_.textContent=`${v(g)} €`:(_.textContent=`${v(f.toFixed(0))} €`,setTimeout(y,10))}y()},v=function(_){return _.toString().replace(/\B(?=(\d{3})+(?!\d))/g," ")};var calculateResult=r,animateNumber=p,numberWithSpaces=v;const t=document.querySelector(".capital-calculator-section__result-value"),n=document.querySelectorAll(".capital-calculator-section__cursors-container__cursor-container input"),a=document.querySelector("#first-range"),s=document.querySelector("#second-range"),e=document.querySelector("#third-range"),c=document.querySelector("#fourth-range");n.forEach(_=>_.addEventListener("input",function(){const g=(this.value-this.min)/(this.max-this.min)*100,x=_.value.split("");x.splice(-3,0," "),(_.name="first-range")&&(_.labels[0].textContent=`${x.join("")} ${_.getAttribute("data-attr")}`),this.style.background=`linear-gradient(to right, #ff6442 0%, #ff6442 ${g}%, #fbe1da ${g}%, #fbe1da 100%)`,r()})),r()}const ae=document.querySelectorAll(".promo-banner-section");ae.forEach(t=>{t.querySelector(".promo-banner-section__items-section__items");const n=t.querySelectorAll(".promo-banner-section__items-section__items__item"),a=t.querySelector(".promo-banner-section__items-section__left-arrow"),s=t.querySelector(".promo-banner-section__items-section__right-arrow");let e=0;n.length>1&&(s.style.display="block",a.style.display="block",s.addEventListener("click",()=>{e=(e+1)%n.length,c(e)},{passive:!0}),a.addEventListener("click",()=>{e=(e-1+n.length)%n.length,c(e)},{passive:!0}));function c(r){n.forEach(p=>{p.style.transform=`translateX(-${r*100}%)`})}c(e)});const T={initialInvestissement:1e5,selectedBtns:["France","Europe","Commerces"]};document.querySelector(".scpi-selector__selectors-container__resultsCards");const oe=document.querySelectorAll(".scpi-selector__selectors-container__sectoralCategory__btns-container__btn, .scpi-selector__selectors-container__geographicalArea__btns-container__btn"),k=document.querySelector(".scpi-selector__selectors-container__initial-investissement-container input"),ce=document.querySelector(".scpi-selector__selectors-container__initial-investissement-container label");k.addEventListener("input",le);oe.forEach(t=>t.addEventListener("click",n=>de(n,T.selectedBtns)));function le(){T.initialInvestissement=k.value;const t=(k.value-k.min)/(k.max-k.min)*100,n=k.value.split("");n.splice(-3,0," "),ce.textContent=`${n.join("")} €`,k.style.background=`linear-gradient(to right, #ff6442 0%, #ff6442 ${t}%, #fbe1da ${t}%, #fbe1da 100%)`}function de(t,n){const a=t.target.getAttribute("data-attr");handleSelectedOptionBtn(n,a)}
